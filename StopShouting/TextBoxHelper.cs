    ...
    public static class TextBoxHelper
    {
        ...
        public class PlaceholderAdorner(TextBox textBox) : Adorner(textBox)
        {
            protected override void OnRender(DrawingContext drawingContext)
            {
                ...
                var placeholderValue = TextBoxHelper.GetPlaceholder(textBoxControl);
                ...
                {
                    MaxTextWidth = System.Math.Max(textBoxControl.ActualWidth - textBoxControl.Padding.Left - textBoxControl.Padding.Right, 10),
                    MaxTextHeight = System.Math.Max(textBoxControl.ActualHeight, 10)
                };
